...
namespace GOAP
{
    ...
    public class ActionPlanner
    {
        ...
        private List<ActionGoap> _actions = new List<ActionGoap>();

        private List<ActionGoap> _viableActions = new List<ActionGoap>();
        ...
        public void AddAction(ActionGoap action)
        {
        ...
        public Stack<ActionGoap> Plan(WorldState startState, WorldState goalState, List<AStarNode> selectedNodes = null)
        {
        ...
        internal int FindActionIndex(ActionGoap action)
        {
