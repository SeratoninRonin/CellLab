...
namespace GOAP
{
    ...
    public class AStar
    {
        private static AStarStorage storage = new AStarStorage();
        ...
        */
        ...
        public static Stack<ActionGoap> Plan(ActionPlanner ap, WorldState start, WorldState goal,
        ...
        private static Stack<ActionGoap> ReconstructPlan(AStarNode goalNode, List<AStarNode> selectedNodes)
        {
            var totalActionsInPlan = goalNode.Depth - 1;
            var plan = new Stack<ActionGoap>(totalActionsInPlan);
